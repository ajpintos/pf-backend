...
const { handlerGetAllOrders, handlerPostOrder, handlerPutOrders, handlerDeleteOrders, handlerGetOrderById } = require("../handlers/ordersHandlers.js")
...
ordersRouter.put('/', handlerPutOrders);
